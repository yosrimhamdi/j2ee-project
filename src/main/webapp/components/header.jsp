<div id="sticky-wrapper" class="sticky-wrapper is-sticky" style="height: 79.6719px;">
  <header class="site-navbar py-4 js-sticky-header site-navbar-target shrink" role="banner" style="width: 1349px; position: fixed; top: 0px; z-index: inherit;">
    <div class="container">
