                    ...
                    %>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<%= request.getContextPath() %>/admin/events/delete?id=<%= event.getId() %>" type="button" class="button red" onclick="return confirm('Are you sure you want to delete this event?');">Delete</a>
                            </td>
                         </tr>
                    <% } %>
                </tbody>
